...
public sealed class StatisticsService
{
	...
	public IReadOnlyDictionary<string, List<DateTime>> EnpointToRequestsTime
		=> _enpointToRequestsTime.AsReadOnly();
	...
	{
		if(!_enpointToRequestsTime.ContainsKey(endpointName)) {
			_enpointToRequestsTime.Add(endpointName, new List<DateTime>());
		}

		var list = _enpointToRequestsTime[endpointName];
